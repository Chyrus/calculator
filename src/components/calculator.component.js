  ...
  render() {
    return (
      <div className="calculator">
        <tr>
          <td><button name="C" onClick={e => this.props.onClick(e.target.name)}>C</button></td>
        ...
        <tr>
          ...
          <td><button name="*" onClick={e => this.props.onClick(e.target.name)}>x</button></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><button name="0" onClick={e => this.props.onClick(e.target.name)}>0</button></td>
          <td><button name="." onClick={e => this.props.onClick(e.target.name)}>.</button></td>
          <td><button name="=" onClick={e => this.props.onClick(e.target.name)}>=</button></td>
          <td><button name="+" onClick={e => this.props.onClick(e.target.name)}>+</button></td>
        </tr>
